...
// Get
func (f *IBMPIDhcpClient) Get(id, cloudInstanceID string) (dhcpServer *models.DHCPServer, err error) {
	return f.GetWithContext(context.Background(), id, cloudInstanceID)
}

// Get with Context...
func (f *IBMPIDhcpClient) GetWithContext(ctx context.Context, id, cloudInstanceID string) (dhcpServer *models.DHCPServer, err error) {
